  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0d1117]">
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        ...
        {/* PRs / Bests */}
        {(longestActivity || fastestActivity || mostElevationActivity) && (
          <div className="mt-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              {fastestActivity && (
                <div className="p-4 border border-gray-200 dark:border-[#30363d] rounded-lg bg-white dark:bg-[#0d1117]">
                  ...
                  <p className="text-xl font-bold text-gray-900 dark:text-white">
                    {isPaceSport
                      ? formatPace(fastestActivity.average_speed)
                      : formatSpeed(fastestActivity.average_speed)}
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 truncate">
              ...
              {mostElevationActivity && (
                <div className="p-4 border border-gray-200 dark:border-[#30363d] rounded-lg bg-white dark:bg-[#0d1117]">
                  ...
                  <p className="text-xl font-bold text-gray-900 dark:text-white">
                    {formatElevation(mostElevationActivity.total_elevation_gain)}
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 truncate">
